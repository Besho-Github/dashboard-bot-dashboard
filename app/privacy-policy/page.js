...
const Policy = () => {
  ...
  const policyContent = locale.policy.sections;

  return (
    <>
      <Head>
        <title>Privacy Policy - Wicks Bot</title>
        <meta name="description" content="Learn about how we protect your privacy and handle your data at Wicks Bot" />
